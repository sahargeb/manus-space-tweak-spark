...
const Brochures = () => {
  ...
  const catalogData: CatalogItem[] = [
    ...
    },
    {
      ...
      category: "Kitchens",
      color: "green",
      downloadLink: "https://drive.google.com/uc?export=download&id=1example",
      viewLink: "https://drive.google.com/file/d/1example/view?usp=sharing"
    },
    {
      id: 3,
      title: "TILES & SLABS",
    ...
    // New catalogs added below
    {
      id: 11,
      title: "Surfaces BAGNODESIGN 2025",
      description: "أحدث مجموعة من الأسطح والخامات الفاخرة من باجنو ديزاين لعام 2025",
      image: "/lovable-uploads/7faacff0-c062-45be-a06c-6eeea8c452f4.png",
      category: "Surfaces",
      color: "purple",
      downloadLink: "https://drive.google.com/uc?export=download&id=1surfaces2025",
      viewLink: "https://drive.google.com/file/d/1surfaces2025/view?usp=sharing"
    },
    {
      id: 12,
      title: "BATHROOM & SPA BRANDS 2025",
      description: "أحدث علامات الحمامات والمنتجعات الصحية الفاخرة لعام 2025",
      image: "/lovable-uploads/cb15b01a-60cb-4c98-a716-adc3a533ffe1.png",
      category: "Spa",
      color: "green",
      downloadLink: "https://drive.google.com/uc?export=download&id=1spabands2025",
      viewLink: "https://drive.google.com/file/d/1spabands2025/view?usp=sharing"
    },
    {
      id: 13,
      title: "LUXURY LIFESTYLE",
      description: "مجموعة نمط الحياة الفاخرة مع تصاميم حصرية وأناقة استثنائية",
      image: "/lovable-uploads/9aeb9520-2fde-4256-a34e-02e66cacb4c7.png",
      category: "Luxury",
      color: "purple",
      downloadLink: "https://drive.google.com/uc?export=download&id=1luxurylifestyle",
      viewLink: "https://drive.google.com/file/d/1luxurylifestyle/view?usp=sharing"
    },
    {
      id: 14,
      title: "LIGHTING PRICE GUIDE",
      description: "دليل شامل لأسعار الإضاءة مع أحدث التقنيات والحلول المبتكرة",
      image: "/lovable-uploads/ebc86740-145f-4948-8f14-80f4872a5697.png",
      category: "Lighting",
      color: "green",
      downloadLink: "https://drive.google.com/uc?export=download&id=1lightingprice",
      viewLink: "https://drive.google.com/file/d/1lightingprice/view?usp=sharing"
    },
    {
      id: 15,
      title: "OUTDOOR KITCHENS & BBQS",
      description: "المطابخ الخارجية وأجهزة الشواء الفاخرة للحدائق والمساحات الخارجية",
      image: "/lovable-uploads/aa0fdce0-e4b0-42f4-ab29-2288b73266ca.png",
      category: "Outdoor",
      color: "green",
      downloadLink: "https://drive.google.com/uc?export=download&id=1outdoorkitchens",
      viewLink: "https://drive.google.com/file/d/1outdoorkitchens/view?usp=sharing"
    },
    {
      id: 16,
      title: "Hotel Amenities Premium",
      description: "مرافق ووسائل الراحة الفندقية المتطورة للضيافة الفاخرة",
      image: "/lovable-uploads/c1515818-817a-4205-88ba-c92af98c3f54.png",
      category: "Hotels",
      color: "blue",
      downloadLink: "https://drive.google.com/uc?export=download&id=1hotelamenities",
      viewLink: "https://drive.google.com/file/d/1hotelamenities/view?usp=sharing"
    }
  ];
