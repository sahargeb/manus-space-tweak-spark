                ...
                <div className="relative overflow-hidden">
                  <Dialog>
                    <DialogTrigger asChild>
                      <img src={product.image} alt="BAGNODESIGN مصر - أحواض راقية مصنوعة من مواد فاخرة وخلاطات ذهبية فاخرة تصميم سبا حضري" className="w-full h-48 sm:h-56 md:h-64 object-cover group-hover:scale-105 transition-transform duration-300 cursor-pointer" />
                    </DialogTrigger>
                    <DialogContent className="max-w-[95vw] sm:max-w-4xl w-full p-2 sm:p-0 bg-transparent border-none">
                      <div className="relative">
                        <img src={product.image} alt="BAGNODESIGN Egypt - Contemporary luxury bathroom furniture of highest quality with LED illuminated mirrors" className="w-full h-auto max-h-[85vh] sm:max-h-[90vh] object-contain rounded-lg" />
                      </div>
                    </DialogContent>
                  </Dialog>
                  ...
                  <Dialog>
                    ...
                    <DialogContent className="max-w-[95vw] sm:max-w-2xl">
                      <div className="space-y-4">
                        <img src={product.image} alt="BAGNODESIGN مصر - ملحقات حمام فاخرة رف مناشف، موزع صابون، حاملة قطن مع إضاءة حمام دافئ بتصميم حصري" className="w-full h-48 sm:h-64 object-cover rounded-lg" />
                        <div>
