      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <div className="grid grid-cols-3 gap-8 max-w-5xl mx-auto">
            {/* First Row */}
            <div className="bg-black/70 backdrop-blur-lg p-8 rounded-2xl text-center hover:bg-black/80 hover:scale-105 transition-all duration-500 cursor-pointer shadow-2xl border-2 border-white/20 group">
              <h3 className="font-bold text-xl text-white tracking-wide animate-bounce">
                <span className="drop-shadow-2xl text-white">SPA & WELLNESS</span>
              </h3>
            </div>
            <div className="bg-black/70 backdrop-blur-lg p-8 rounded-2xl text-center hover:bg-black/80 hover:scale-105 transition-all duration-500 cursor-pointer shadow-2xl border-2 border-white/20 group">
              <h3 className="font-bold text-xl text-white tracking-wide animate-pulse">
